...
import { ArrowRight, Lightbulb, Gem, Heart, Wrench, ShieldCheck } from 'lucide-react'
              ...
              const runCycle = () => {
                ...
                const dipTimer = setInterval(() => {
                  ...
                  if (p < 0.35) {
                    ...
                    v = Math.round((stat.value - dip) + dip * (1 - Math.pow(1 - up, 3)))
                  }
...
function ValueItem({ v, index }: { v: typeof values[0]; index: number }) {
  ...
  return (
    <motion.div
      variants={{ hidden: {}, visible: { transition: { staggerChildren: 0.0 } } }}
      style={{ position: 'relative', paddingBottom: 28, marginBottom: 0 }}
    ...
    >
      ...
      {/* Content */}
      <motion.div variants={valueBodyVariants} style={{ position: 'relative', zIndex: 1, paddingLeft: 0 }}>
        {/* Icon + Title row */}
        ...
        <p style={{ color: '#4a4a4a', fontSize: 14, fontWeight: 300, lineHeight: 1.7, marginBottom: 20, paddingLeft: 25 }}>{v.desc}</p>
    ...
    <div style={{ background: '#f5f2ed' }} className="pt-20">
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          <FadeIn>
            <p style={{ fontFamily: "'Montserrat', sans-serif", color: '#a18661', fontSize: 10, letterSpacing: '0.4em', textTransform: 'uppercase', marginBottom: 24 }}>Our Story</p>
            <h1 className="font-serif font-light leading-tight mb-6" style={{ fontSize: 'clamp(2.8rem, 6vw, 4.5rem)', color: '#21291a' }}>
              Design With<br />
              <em style={{ color: '#a18661' }}>Purpose & Craft</em>
            </h1>
            <p style={{ color: '#4a4a4a', fontWeight: 300, lineHeight: 1.75, maxWidth: 560, margin: '0 auto', fontSize: 15 }}>
      ...
      <section className="py-24" style={{ background: '#f5f2ed', borderTop: '1px solid rgba(161,134,97,0.15)' }}>
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <FadeIn delay={0.2} direction="left">
            <p style={{ fontFamily: "'Montserrat', sans-serif", color: '#a18661', fontSize: 10, letterSpacing: '0.4em', textTransform: 'uppercase', marginBottom: 24 }}>Who We Are</p>
      ...
      <section className="py-28" style={{ background: '#f5f2ed' }}>
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-24 items-start">
          ...
          <div>
            <FadeIn>
              <p style={{ fontFamily: "'Montserrat', sans-serif", color: '#a18661', fontSize: 10, letterSpacing: '0.4em', textTransform: 'uppercase', marginBottom: 24 }}>What We Design</p>
            ...
            >
              {offerings.map((o, i) => (
                <motion.li
                  ...
                  style={{ display: 'flex', alignItems: 'flex-start', gap: 14, color: '#4a4a4a', fontWeight: 300, lineHeight: 1.7, fontSize: 15 }}
                >
                  {/* Gold diamond bullet */}
          ...
          <div style={{ position: 'relative' }}>
            {/* Decorative faint circle behind numbers */}
            <svg
              aria-hidden="true"
              style={{
                position: 'absolute',
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              <FadeIn delay={0.1}>
                <p style={{ fontFamily: "'Montserrat', sans-serif", color: '#a18661', fontSize: 10, letterSpacing: '0.4em', textTransform: 'uppercase', marginBottom: 32 }}>Our Values</p>
              </FadeIn>
              <motion.div
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <motion.div
              ...
              style={{ border: '1px solid rgba(161,134,97,0.25)', padding: 40, borderRadius: 4, cursor: 'default', transition: 'border-color 0.4s ease' }}
            >
              <p style={{ fontFamily: "'Montserrat', sans-serif", color: '#a18661', fontSize: 10, letterSpacing: '0.4em', textTransform: 'uppercase', marginBottom: 24 }}>Mission</p>
            ...
            <motion.div
              ...
              style={{ border: '1px solid rgba(161,134,97,0.25)', padding: 40, borderRadius: 4, cursor: 'default', transition: 'border-color 0.4s ease' }}
            >
              <p style={{ fontFamily: "'Montserrat', sans-serif", color: '#a18661', fontSize: 10, letterSpacing: '0.4em', textTransform: 'uppercase', marginBottom: 24 }}>Vision</p>
              <p className="font-serif font-light leading-relaxed" style={{ fontSize: 'clamp(1.3rem, 2.5vw, 1.6rem)', color: '#21291a' }}>
      ...
      <section className="py-24" style={{ background: '#f5f2ed', borderTop: '1px solid rgba(161,134,97,0.15)' }}>
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
          <FadeIn delay={0.2}>
            <p style={{ fontFamily: "'Montserrat', sans-serif", color: '#a18661', fontSize: 10, letterSpacing: '0.4em', textTransform: 'uppercase', marginBottom: 24 }}>The Founder</p>
